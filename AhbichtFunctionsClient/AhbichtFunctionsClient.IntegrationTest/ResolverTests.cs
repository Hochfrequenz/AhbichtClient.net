...
public class ResolverTests : IClassFixture<ClientFixture>
{
    ...
    public async Task Packages_Can_Be_Resolved()
    {
        ...
        IPackageKeyToConditionResolver client = new AhbichtFunctionsRestClient(httpClientFactory, _authenticator);
    ...
    {
        var httpClientFactory = _client.HttpClientFactory;
        IConditionKeyToTextResolver client = new AhbichtFunctionsRestClient(httpClientFactory, _authenticator);
